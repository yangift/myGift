		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					<li class="active"><a class="" href="sal_index.jsp"> <i
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-files-o"></i>指派销售机会</li>
						</ol>
					</div>
				</div>
				<div class="col-md-12">
					<form action="salchance?flag=addDue" method="post">
						<div class="row">
							<div class="col-md-3 col-md-offset-9 text-center ">
								<button class="btn btn-info" type="button"
									onclick="window.location.href='sal_index.jsp'">返回</button>
								<button class="btn btn-info" type="submit">指派</button>
							</div>
								...
								<table class="table">
									...
									<tr>
										...
										<td><input type="text" name="chcRate"
											class="form-control" value="<%=sal.getChcRate()%>" readonly /></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" name="chcLinkman"
											class="form-control" value="<%=sal.getChcLinkman()%>"
											readonly /></td>
									...
									<tr>
										...
										<td><select class="form-control" name="ChcDueName">
												<%
													List<Consumer> listConsumer = (List<Consumer>) request
															.getAttribute("listConsumer");
													if (listConsumer != null) {
														for (int i = 0; i < listConsumer.size(); i++) {
												%>
												<option><%=listConsumer.get(i).getConName()%></option>
												<%
													}
													}
												%>
										...
										<td>
											...
											value="<%=sal.getChcDueDate()%>" /> <%
 											} else {
 											%> <input type="text" name="chcDueDate" class="form-control"
												id="showtime" /> <%
 											}%> <!-- 这里需要指明已经分配 --> 
 										<input type="hidden" value="已分配" name="chcStatus" />
										</td>
									</tr>
								</table>
							</div>
