...
<script type="text/javascript">
	function page(pageNum, pageCount) {
		...
		document.form1.action = "salchance?flag=query&page=" + pageNum;
			...
			<section class="wrapper">
				...
				<div class="col-md-12">
					<form class="form-horizontal" role="form"
						action="salchance?flag=query" method="post" name="form1">
						<div class="row">
							<div class="col-md-1 ">
							...
							<div class="col-md-3">
								...
								<a href="sal_chanceAdd.jsp"><button class="btn btn-info"
										type="button">新建</button></a>
							...
							<table class="table">
								...
								<tbody >
									...
									<tr>
										...
										<td><%=sc.getChcTel()%></td>
										<td><a href="salchance?flag=due&chcId=<%=sc.getChcId()%>" title="指派"> <span
												class="glyphicon glyphicon-send">&nbsp;</span></a><a
											href="salchance?flag=initEdit&chcId=<%=sc.getChcId()%>"
											title="修改"> <span class="glyphicon glyphicon-pencil">&nbsp;</span>
										</a> <a href="salchance?flag=del&chcId=<%=sc.getChcId()%>" title="删除"> <span
