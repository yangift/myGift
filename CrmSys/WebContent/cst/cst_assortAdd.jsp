	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="col-md-12">
				<form  class = "form-horizontal" method = "post" action="assort?flag=add&cusId=<%=cusId%>">
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							<table class="table">
								...
								<tr>
									...
									<td>
									<input type="date" name="assDate" class="form-control"   /></td>
									<td><label class="control-label">地点:</label></td>
									<td>
									<input type="text" name="assPalce" class = "form-control"  />
									</td>
								</tr>
								<tr>
									<td><label class="control-label"><span style ="color:red">*</span>&nbsp;概要:</label></td>
									<td><input type="text" name="assResume" class="form-control"  /></td>
									<td><label class="control-label">备注:</label></td>
									<td><input type="text" name="assMemo" class="form-control"/></td>
								</tr>
								<tr>
									<td><label class="control-label">详细信息:</label></td>
									<td colspan="3">
									<textarea class = "form-control" name ="assDetal" ></textarea>
									</td>
								</tr>						
							</table>
						</div>						
