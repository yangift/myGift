...
<%
	...
	Linkman lin = (Linkman)request.getAttribute("lin");
%>
<body onload = "systemTime()">
	...
	<section id="container" class="">
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="col-md-12">
				<form  class = "form-horizontal" method = "post" action="linkman?flag=update&cusId=<%=cusId %>&linId=<%=lin.getLinId()%>">
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							<table class="table">
								...
								<tr>
									...
									<td>
									<input type="text" name="linName" class="form-control" value = "<%=lin.getLinName() %>"    /></td>
									<td><label class="control-label">性别:</label></td>
									<td><label  class="radio-inline">
									<input type="radio" name="linSex" class="radio" value = "男" />男
									 </label>
								...
								<tr>
									...
									<td><input type="text" name="linPost" class="form-control" value = "<%=lin.getLinPost() %>" /></td>
									<td><label class="control-label"><span style ="color:red">*</span>&nbsp;办公电话:</label></td>
									<td><input type="text" name="linTelephone" class="form-control" value = "<%=lin.getLinTelephone()%>"/></td>
								</tr>
								<tr>
									<td><label class="control-label">手机:</label></td>
									<td ><input type="text" name="linMobile"
										class="form-control" value = "<%=lin.getLinMobile() %>" /></td>
										<td >备注</td>
										<td><input type="text" name="linMemo"
										class="form-control" value = "<%=lin.getLinMemo() %>" />
										</td>
								</tr>						
							</table>
						</div>						
	...
	<%
		int i= -1;
		if(lin.getLinSex().equals("男")){
			 i = 0;
		}else if(lin.getLinSex().equals("女")){
			 i = 1;
		}
	%>
	$("input[name = 'linSex']").get(<%=i%>).checked=true;
	</script>
</body>
</html>
