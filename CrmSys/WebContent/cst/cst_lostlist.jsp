				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-files-o"></i>客户流失列表</li>
						</ol>
					</div>
				</div>
				<div class="col-md-12">
							...
							<table class="table">
								...
								<tbody >
									...
									<tr>
										...
										<td><%=cus.getCusManager()%></td>
										<td><%=cus.getOrderses()%></td>
										<td><%=cus.getCusAllotDate()%></td>
										<td><%=cus.getCusStateTaxes() %></td>
										<td><a
											href="customer?flag=initEdit&cusId=<%=cus.getCusId()%>"
											title="展缓流失"> <span class="glyphicon glyphicon-refresh">&nbsp;</span>
										</a> <a href="salchance?flag=del&cusId=<%=cus.getCusId()%>" title="已流失"> <span
