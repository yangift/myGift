...
<script type="text/javascript">
	function page(pageNum, pageCount) {
		...
		document.form1.action = "linkman?flag=query&cusId=<%=cus.getCusId()%>&page=" + pageNum;
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li><i class="fa fa-files-o"></i>客户联系人列表</li>
						</ol>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-5 col-md-offset-8 text-center ">
					...
					<a href = "cst_linkmanAdd.jsp?cusId=<%=cus.getCusId()%>"><button class="btn btn-info" type = "button" >新建</button></a>
				</div>
				</div>
					...
					<div class="row">
						<div class="col-md-10 col-md-offset-1">
							<table class="table">
								...
								<tbody >
									<%
										List<Linkman> list = (List<Linkman>) request
												.getAttribute("linList");
									...
									%>
									<tr>
										<td><%=lin.getLinName()%></td>
										<td><%=lin.getLinSex()%></td>
										<td><%=lin.getLinPost()%></td>
										<td><%=lin.getLinTelephone()%></td>
										<td><%=lin.getLinMobile()%></td>
										<td><%=lin.getLinMemo() %></td>
										<td><a
											href="linkman?flag=initEdit&linId=<%=lin.getLinId()%>&cusId=<%=cus.getCusId()%>"
											title="编辑联系人"> <span class="glyphicon glyphicon-pencil">&nbsp;</span>
										</a> <a href="salchance?flag=del&cusId=<%=lin.getLinId()%>" title="删除"> <span
